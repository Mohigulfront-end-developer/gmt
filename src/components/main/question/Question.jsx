...
const Question = () => {
  return (
    <div className="bg-[#F8F7F3]">
      <div className="container flex justify-between gap-5 pb-[150px]">
        ...
        <div className="bg-[white] pt-10 px-10 rounded-lg">
          ...
          <input
            ...
            className="outline-none bg-transparent px-4 py-2  border-b-[1px] border-b-[#7A768] w-full text-[18px] font-normal"
          />
          <input
            type="text"
          ...
          <input
            ...
            className="outline-none bg-transparent px-4  pb-[100px]  border-b-[1px] border-b-[#7A768] w-full text-[18px] font-normal"
          />
          <div className="flex items-center justify-between gap-4 mt-10">
            <button className="bg-[#088269] px-6 py-2 rounded-full text-white">Отправить</button>
